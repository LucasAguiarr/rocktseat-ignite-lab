...
import codeMockup from "../../src/assets/images/code-mockup.png"
export function Subscribe() {
  ...
  return (
    <div className="max-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center overflow-hidden">
